...
### [Version 1.2.6](https://github.com/azurecurve/azrcrv-rss-feed/releases/tag/v1.2.6)
 * Update plugin header for compatibility with ClasssicPress v2.
 
### [Version 1.2.5](https://github.com/azurecurve/azrcrv-rss-feed/releases/tag/v1.2.5)

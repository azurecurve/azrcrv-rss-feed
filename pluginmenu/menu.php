 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_rssf')){
	function azrcrv_create_plugin_menu_rssf(){
		azrcrv_create_plugin_menu_table_rssf();
		azrcrv_populate_plugin_menu_table_rssf();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_rssf')){
	function azrcrv_populate_plugin_menu_table_rssf(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_rssf')){
	function azrcrv_create_plugin_menu_table_rssf(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
